...
var ChannelMoveLeftButtonView = { type : 'ChannelMoveLeftButtonView',
                                  model : 'channel',
                                  className : 'TinyButton ChannelLeftButton',
                                  events : { 'click' : function (e) {
...
var ChannelMoveRightButtonView = { type : 'ChannelMoveRightButtonView',
                                   model : 'channel',
                                   className : 'TinyButton ChannelRightButton',
                                   events : { 'click' : function (e) {
...
var ChannelAddButtonView = { type : 'ChannelAddButtonView',
                             model : 'channel',
                             className : 'TinyButton ChanneAddButton',
                             events : { 'click' : function (e) {
...
var ChannelCopyButtonView = { type : 'ChannelCopyButtonView',
                              model : 'channel',
                              className : 'TinyButton ChannelCopyButton',
                              events : { 'click' : function (e) {
...
var PatternPlayButtonView = { type : 'PatternPlayButtonView',
                              model : 'pattern',
                              className : 'TinyButton PatternPlayButton',
                              events : { 'click' : function (e) {
...
var PatternLoopButtonView = { type : 'PatternLoopButtonView',
                              model : 'pattern',
                              className : 'TinyButton PatternLoopButton',
                              events : { 'click' : function (e) {
...
var PatternMoveUpButtonView = { type : 'PatternMoveUpButtonView',
                                model : 'pattern',
                                className : 'TinyButton PatternUpButton',
                                events : { 'click' : function (e) {
...
var PatternMoveDownButtonView = { type : 'PatternMoveDownButtonView',
                                  model : 'pattern',
                                  className : 'TinyButton PatternDownButton',
                                  events : { 'click' : function (e) {
...
var PatternAddButtonView = { type : 'PatternAddButtonView',
                             model : 'pattern',
                             className : 'TinyButton PatternAddButton',
                             events : { 'click' : function (e) {
...
var PatternCopyButtonView = { type : 'PatternCopyButtonView',
                              model : 'pattern',
                              className : 'TinyButton PatternCopyButton',
                              events : { 'click' : function (e) {
...
var PatternLinkButtonView = { type : 'PatternLinkButtonView',
                              model : 'pattern',
                              className : 'TinyButton PatternLinkButton',
                              events : { 'click' : function (e) {
...
var PatternCloseButtonView = { type : 'PatternCloseButtonView',
                               model : 'pattern',
                               className : 'TinyButton PatternCloseButton',
                               events : { 'click' : function (e) {
    if (options.confirm()) {
...
var SoundManager = { type : 'SoundManager',
    ...
    var instrument1;
    return this.notes.push((instrument1 = note.instrument(), instrument1 && instrument1 < this.instruments.length ? [beat * this.mspb, this.instruments.at(note.instrument())] : null));
},
                     play : function () {
    return null;
}
